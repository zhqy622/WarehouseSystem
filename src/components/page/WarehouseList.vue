  ...
  <div>
    <!-- <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 仓库列表 </el-breadcrumb-item>
      </el-breadcrumb>
    </div> -->
    <div class="container">
      <div class="handle-box">
        <el-button type="primary" icon="el-icon-delete" class="handle-del mr10" @click="delAllSelection">批量删除</el-button>
        <el-input v-model="searchText" placeholder="仓库名称" class="handle-input mr10"></el-input>
        <el-button type="primary" icon="el-icon-search" @click="handleSearch">搜索</el-button>
        <el-button type="success" icon="el-icon-lx-add" @click="handleAdd">添加仓库</el-button>
      ...
      >
        ...
        <el-table-column prop="currSize" label="当前库存"></el-table-column>
        <el-table-column label="仓库状态" align="center">
          <template slot-scope="scope">
            <el-tag :type="scope.row.status === 'online' ? 'success' : scope.row.status === 'offline' ? 'warning' : ''">{{
              scope.row.status
            }}</el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-lx-hot" @click="handleStart(scope.row.id)">启动</el-button>
    ...
    <!-- 添加弹出框 -->
    <el-dialog title="添加仓库" :visible.sync="addVisible" width="30%">
      <el-form ref="form" :model="form" label-width="70px">
        <el-form-item label="仓库名称">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleStart(index) {
      this.$router.push({ name: 'warehouse', params: { id: index } })
    },
    handleAdd() {
      this.form = {}
